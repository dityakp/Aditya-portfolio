...
export const experiencesData = [
  {
    ...
    proofs: [
      { name: "Offer Letter", icon: <FileText size={20} />, docPath: "/documents/pearlthoughts/" },
      { name: "Internship Completion Certificate", icon: <FileBadge size={20} />, docPath: "/documents/pearlthoughts/" }
    ],
    certificates: [],
  ...
  },
  {
    ...
    proofs: [
      { name: "Official Appointment Letter", icon: <FileText size={20} />, docPath: "/documents/cid-jharkhand/" },
      { name: "CID Commendation Letter", icon: <Award size={20} />, docPath: "/documents/cid-jharkhand/" }
    ],
    certificates: [],
  ...
  },
  {
    ...
    proofs: [
      { name: "Internship Offer Letter", icon: <FileText size={20} />, docPath: "/documents/bccl/" },
      { name: "Experience Certificate", icon: <FileBadge size={20} />, docPath: "/documents/bccl/" }
    ],
    certificates: [],
